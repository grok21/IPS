...
/// ������������, ������������ ��� ����� ����������� ����������
/// ������� �������� �������: �� ������� ��� �� ��������
enum class eprocess_type_3
{
	by_rows = 0,
	by_cols
};

void InitMatrix_3( double** matrix, const size_t numb_rows, const size_t numb_cols )
{
...
void PrintMatrix_3( double** matrix, const size_t numb_rows, const size_t numb_cols )
{
...
/// numb_cols - ���������� �������� � �������� ������� <i>matrix</i>
/// average_vals - ������, ���� ����������� ����������� ������� ��������
void FindAverageValues_3( eprocess_type_3 proc_type, double** matrix, const size_t numb_rows, const size_t numb_cols, double* average_vals )
{
	switch ( proc_type )
	{
		case eprocess_type_3::by_rows:
		{
			for ( size_t i = 0; i < numb_rows; ++i )
			{
...
void PrintAverageVals_3( eprocess_type_3 proc_type, double* average_vals, const size_t dimension )
{
	switch ( proc_type )
	{
		case eprocess_type_3::by_rows:
...
void task3_run()
{
	...
	try
	{
		...
		InitMatrix_3( matrix, numb_rows, numb_cols );
		std::cout << "-------------------------------------------------------------------------\nBase program + cilk_for + memory clearing\n\n";

		PrintMatrix_3( matrix, numb_rows, numb_cols );

		auto start = clock() / 1000.0;
		std::thread first_thr( FindAverageValues_3, eprocess_type_3::by_rows, matrix, numb_rows, numb_cols, average_vals_in_rows );
		std::thread second_thr( FindAverageValues_3, eprocess_type_3::by_cols, matrix, numb_rows, numb_cols, average_vals_in_cols );
	

		first_thr.join();
		second_thr.join();
		auto end = clock() / 1000.0;
		PrintAverageVals_3( eprocess_type_3::by_rows, average_vals_in_rows, numb_rows );
		PrintAverageVals_3( eprocess_type_3::by_cols, average_vals_in_cols, numb_cols );
		std::cout << "Duration: " << end-start << "\n";
		
		// Чистим память, чтобы предотвратить утечку 
